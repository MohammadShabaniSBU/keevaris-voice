...
- There is one source of truth for prompt, greeting, and filler, and it is `unit-hq-api`. A local copy is a defect. Currently violated by `src/agent/prompt.ts`; V03-01 closes it.
